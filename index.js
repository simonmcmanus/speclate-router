...
var onClick = function (elements, routerOptions, speclateOptions) {
  return function (e) {
    ...
    if (isLocal) {
      ...
      pageChange(newLocation, elements, routerOptions, speclateOptions)
    }
  }
}

var pageChange = function (newLocation, elements, routerOptions, speclateOptions) {
...
var setupLinks = function (routerOptions, speclateOptions) {
  ...
  for (var i = 0; i < links.length; i++) {
    ...
    links[i].addEventListener('click', onClick(elements, routerOptions, speclateOptions), { capture: false })
  }
}
